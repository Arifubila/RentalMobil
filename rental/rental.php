            ...
            <div class="input-group-append">
                ...
                <div class="container-fluid">
                    <div class="mb-3" style="background: #222831; border-radius: 20px 20px 15px 15px;">
                        <div class="p-3 text-white" style="background-color: #31363F; border-radius: 15px 15px 0px 0px;">Data Rental</div>
                        <div class="card-body text-success">
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <a href='tambah_rental.php' class='btn custom-btn'>Tambah Data</a>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover text-white">
                                            ...
                                            <tbody>
                                                <?php
                                                include "../koneksi.php";
                                                $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_rental_arif");
                                                while ($data = mysqli_fetch_array($tampil)) {
                                                ?>
                                                    <tr>
                                                        <td data-label="No Trx"><?=$data['no_trx_arif']?></td>
                                                        <td data-label="Tanggal"><?=$data['tgl_rental_arif']?></td>
                                                        <td data-label="Pelanggan"><?=$data['nik_ktp_arif']?></td>
                                                        <td data-label="Mobil"><?=$data['no_plat_arif']?></td>
                                                        <td data-label="Lama"><?=$data['lama_arif']?></td>
                                                        <td data-label="Harga"><?=$data['harga_arif']?></td>
                                                        <td data-label="Total Bayar"><?=$data['total_bayar_arif']?></td>
                                                        <td class="d-flex justify-content-center">
                                                            <a href="edit_rental.php?no_trx_arif=<?=$data['no_trx_arif']?>" class='btn btn-primary mr-3'>Edit</a>
                                                            <a href="#" class="btn btn-danger" onclick="showDeleteModal('delete_rental.php?no_trx_arif=<?=$data['no_trx_arif']?>')">Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="daftar_rental" id="confirmDelete" class="btn btn-danger">Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

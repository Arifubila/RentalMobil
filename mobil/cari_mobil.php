...
$tampil = mysqli_query($koneksi, "SELECT * FROM tbl_mobil_arif WHERE nama_mobil_arif LIKE '%$keyword%'");
...
<!-- Topbar Search -->
    <!-- Topbar Search -->
                    ...
                    <div class="col-md-6 mb-2">
                        <a href='mobil.php' class='btn custom-btn'>Kembali</a>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_mobil.php?nim=<?= $data['no_plat_arif'] ?>" class='btn btn-primary'>Edit</a>
                                                    <a href="delete_mobil.php?nim=<?= $data['no_plat_arif'] ?>" class='btn btn-danger' onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }

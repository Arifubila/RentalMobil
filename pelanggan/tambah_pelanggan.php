    ...
    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="cari_mobil.php" method="GET">
      ...
      <div class="container-fluid">
                        <div class="mb-3" style="background: #222831; border-radius: 20px;">
                            <div class="p-3" style="background-color: #31363F; border-radius: 15px 15px 0 0;">Tambah Data Pelanggan</div>
                            <div class="card-body text-white">
                                <form method="POST" action="insert_pelanggan.php">
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            <label for="nik_ktp_arif" class="form-label">Nik Ktp :</label>
                                            <input type="number" name="nik_ktp_arif" class="form-control" id="nik_ktp_arif" placeholder="Masukan Nik Ktp" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="nama_arif" class="form-label">Nama :</label>
                                            <input type="text" name="nama_arif" class="form-control" id="nama_arif" placeholder="Masukan No Nama" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="no_hp_arif" class="form-label">No Hp :</label>
                                            <input type="number" name="no_hp_arif" class="form-control" id="no_hp_arif" placeholder="Masukan No Hp" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="alamat_arif" class="form-label">Alamat :</label>
                                            <input type="text" name="alamat_arif" class="form-control" id="alamat_arif" placeholder="Masukan Alamat" required>
                                        </div>

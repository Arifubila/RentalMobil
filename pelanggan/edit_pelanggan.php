...
<!-- Topbar Search -->
    ...
    <div class="mb-3" style="background: #222831; border-radius: 20px;">
        <div class="p-3 text-white" style="background-color: #31363F; border-radius: 15px 15px 0 0;">Edit Data Pelanggan</div>
        <div class="card-body text-white">
        <form method="POST" action="update_pelanggan.php">
    <?php
    include "../koneksi.php";
    $nik_ktp_arif = $_GET['nik_ktp_arif'];
    $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_pelanggan_arif WHERE nik_ktp_arif='$nik_ktp_arif'");
    $data = mysqli_fetch_array($tampil);
    ?>
    
    <!-- Input Tersembunyi untuk NIK Lama -->
    <input type="hidden" name="nik_lama" value="<?=$data['nik_ktp_arif']?>">

    <div class="row">
        <div class="col-md-6 mb-3">
            <label for="nik_ktp_arif" class="form-label">Nik Ktp:</label>
            <input type="number" name="nik_ktp_arif" value="<?=$data['nik_ktp_arif']?>" class="form-control" placeholder="Masukan Nik Ktp" required>
        </div>
        <div class="col-md-6 mb-3">
            <label for="nama_arif" class="form-label">Nama :</label>
            <input type="text" name="nama_arif" value="<?=$data['nama_arif']?>" class="form-control" placeholder="Masukan Nama" required>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 mb-3">
            <label for="no_hp_arif" class="form-label">No Hp:</label>
            <input type="number" name="no_hp_arif" value="<?=$data['no_hp_arif']?>" class="form-control" placeholder="Masukan No hp" required>
        </div>
        <div class="col-md-6 mb-3">
            <label for="alamat_arif" class="form-label">Alamat :</label>
            <input type="text" name="alamat_arif" value="<?=$data['alamat_arif']?>" class="form-control" placeholder="Masukan Alamat" required>
        </div>
    </div>
    <div class="mb-3">

...
$tampil = mysqli_query($koneksi, "SELECT * FROM tbl_pelanggan_arif WHERE nama_arif LIKE '%$keyword%'");
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand border-bottom topbar mb-4 static-top shadow" style="background-color: #0F0F0F;">
                    ...
                    <div class="col-md-6 mb-2">
                        <a href='pelanggan.php' class='btn custom-btn'>Kembali</a>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td data-label="Nama"><?= $data['nama_arif'] ?></td>
                                                <td data-label="No Hp"><?= $data['no_hp_arif'] ?></td>
                                                <td data-label="Alamat"><?= $data['alamat_arif'] ?></td>
                                                <td>
                                                    <a href="edit_pelanggan.php?nim=<?= $data['nik_ktp_arif'] ?>" class='btn btn-primary'>Edit</a>
                                                    <a href="delete_pelanggan.php?nim=<?= $data['nik_ktp_arif'] ?>" class='btn btn-danger' onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
